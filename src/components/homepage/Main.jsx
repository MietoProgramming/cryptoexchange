  ...
  return (
    <div>
      ...
      <div className="container">
        <div className="col">
          <div className="row my-4">
            <div className="col-4 col-md-6 text-end my-auto text-white">
              <IconContext.Provider value={{ style: { fontSize: "64px" } }}>
                <GoGlobe />
              </IconContext.Provider>
            </div>
            <div className="col-8 col-md-6 fs-3 text-white">
      ...
      <div className="container">
        <div className="col">
          <div className="row my-4">
            <div className="col-8 col-md-6 fs-3 text-end text-white">
              Have the best information faster.
            </div>
            <div className="col-4 col-md-6 my-auto text-white">
              <IconContext.Provider value={{ style: { fontSize: "64px" } }}>
                <GoRocket />
              </IconContext.Provider>
            </div>
